...
// Class definition
var DeliveredOrdersWeekChart = function () {
    var initDeliveredOrdersWeekChart = function () {
        var elements = document.getElementsByClassName("delivered_orders_week_chart");
    ...
    return {
        init: function () {
            initDeliveredOrdersWeekChart();
        }
    }
}();

KTUtil.onDOMContentLoaded(function() {
    DeliveredOrdersWeekChart.init();
});
