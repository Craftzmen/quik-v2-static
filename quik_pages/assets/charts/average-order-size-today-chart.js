...
// Class definition
var AverageOrderSizeTodayChart = function () {
    var initAverageOrderSizeTodayChart = function () {
        var elements = document.getElementsByClassName("average_order_size_today_chart");
    ...
    return {
        init: function () {
            initAverageOrderSizeTodayChart();
        }
    }
}();
...
KTUtil.onDOMContentLoaded(function() {
    AverageOrderSizeTodayChart.init();
});
