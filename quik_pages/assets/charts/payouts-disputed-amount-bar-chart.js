...
// Class definition
var PayoutsDisputedAmountBarChart = function () {
    var initPayoutsDisputedAmountBarChart = function () {
        var elements = document.getElementsByClassName("payouts_disputed_amount_bar_chart");
    ...
    return {
        init: function () {
            initPayoutsDisputedAmountBarChart();
        }
    }
}();
...
KTUtil.onDOMContentLoaded(function() {
    PayoutsDisputedAmountBarChart.init();
});
