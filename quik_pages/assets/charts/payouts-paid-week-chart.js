...
// Class definition
var PayoutsPaidWeekChart = function () {
    var initPayoutsPaidWeekChart = function () {
        var elements = document.getElementsByClassName("payouts_paid_week_chart");
    ...
    return {
        init: function () {
            initPayoutsPaidWeekChart();
        }
    }
}();

KTUtil.onDOMContentLoaded(function() {
    PayoutsPaidWeekChart.init();
});
