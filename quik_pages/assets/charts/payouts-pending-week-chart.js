...
// Class definition
var PayoutsPendingWeekChart = function () {
    var initPayoutsPendingWeekChart = function () {
        var elements = document.getElementsByClassName("payouts_pending_week_chart");
    ...
    return {
        init: function () {
            initPayoutsPendingWeekChart();
        }
    }
}();

KTUtil.onDOMContentLoaded(function() {
    PayoutsPendingWeekChart.init();
});
